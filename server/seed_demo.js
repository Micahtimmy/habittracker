import { initDatabase, getDb, closeDb } from './src/db.js';
...
// Create Habit 1: "🏃‍♂️ Daily 5km Run" (5-day streak ending today)
...
console.log('Demo habits and multi-day streaks seeded successfully!');
closeDb();
